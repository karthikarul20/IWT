...
$result = mysqli_query($con,"select distinct(category) from nutrition_details");
...
$result = mysqli_query($con,"select distinct(brandname) from nutrition_details");
 ...
 function list_top_food_items($number)
    {
		...
		echo "<script type='text/javascript'>document.getElementById('oferta_title').innerHTML = $popular_food_name;</script>";
        ...
        <div class="oferte_content">
        	...
        	<div class="oferta">
           		...
           		<div class="oferta_content">
                	<img src="images/spicy_tuna.png" width="94" height="92" border="0" class="oferta_img" />
                	
                    <div class="oferta_details">
                            <div class="oferta_title">Spicy Tuna</div>
